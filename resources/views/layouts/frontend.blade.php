...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <link rel='shortcut icon' type='image/x-icon' href='http://200.98.118.194/logo/favicon.ico' />
        <!-- Bootstrap 3.3.7 -->
    ...
    <body class="hold-transition {{ config('adminlte.theme') }} layout-top-nav" style="background: url('http://200.98.118.194/imagens/fundo.jpg') no-repeat center center fixed; 
